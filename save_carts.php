...
if ($request_data !== null) 
{
    ...
    if ($cart_items !=null && $wishlist !=null && $user_token !=null)
    {
       ...
       $find_user_id = "SELECT id FROM users WHERE token = '$user_token'";
        ...
        $save_items="INSERT INTO user_carts (user_id, cart_items, wished_items) VALUES ('$user_id', '$cart_items_json', '$wishlist_json')";
        
        $update_carts="UPDATE user_carts SET cart_items='$cart_items_json', wished_items ='$wishlist_json' WHERE user_id='$user_id'";
